...
var CryptoJS = CryptoJS || function (h, r) {
    var k = {}, l = k.lib = {}, n = function () {
      ...
      init: function (a, b) {
        ...
        a = a.sigBytes;
        this.clamp();
        if (c % 4) for (let e = 0; e < a; e++) b[c + e >>> 2] |= (d[e >>> 2] >>> 24 - 8 * (e % 4) & 255) << 24 - 8 * ((c + e) % 4); else if (65535 < d.length) for (let e = 0; e < a; e += 4) b[c + e >>> 2] = d[e >>> 2]; else b.push.apply(b, d);
        this.sigBytes += a;
        return this
      }, clamp: function () {
        ...
        for (let b = [], d = 0; d < a; d += 4) b.push(4294967296 * h.random() | 0);
